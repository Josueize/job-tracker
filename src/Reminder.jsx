...
const API = "https://job-tracker-production-bacb.up.railway.app/api/reminders";
      ...
      <div style={{ background: "#111118", border: "1px solid #2d2d4e", borderRadius: 20, padding: 32, width: "90%", maxWidth: 420 }}>
        ...
        {success ? (
          <div style={{ textAlign: "center", padding: 20 }}>
            ...
            <button onClick={onClose} style={{ marginTop: 20, background: "#1e1e2e", border: "none", color: "#a0aec0", padding: "10px 24px", borderRadius: 10, cursor: "pointer", fontWeight: 600 }}>
              Close
            </button>
          </div>
        ) : (
          <>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ fontSize: 11, fontWeight: 700, color: "#555570", textTransform: "uppercase", letterSpacing: "0.06em", display: "block", marginBottom: 6 }}>
                Send reminder to
              </label>
              <input
                type="email"
